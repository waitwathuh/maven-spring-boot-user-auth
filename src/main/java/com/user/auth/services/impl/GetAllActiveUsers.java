...
@Service
public class GetAllActiveUsers implements IGetAllActiveUsers
{
	@Autowired
	...
	public UserListResponse getAll( String sessionToken ) throws Exception
	{
		...
		return createResponse( usersDAO.getAllActiveUsers( getTime() ) );
	}
	...
	private Date getTime()
	{
		...
		cal.add( Calendar.MINUTE, ( settingsDAO.getSettings().getLoginHistoryMin() * -1 ) );
		return cal.getTime();
	}
